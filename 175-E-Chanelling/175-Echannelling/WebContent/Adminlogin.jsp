...
<br/><br/>
<div  class="form1" >
    <form method="post" action="Login" name="log"  style="width: 32%;height: 800px " >
        <fieldset  style="border: solid ;background-color: antiquewhite;height: 600px;"  >

            <legend style="color: black"><b>Welcome Administrator to the E-care channeling official Web Page</b></legend><br/>
