...
<body text=black background="3.jpg">
	...
	<a href="Lab.jsp" style="text-decoration:none;padding:10px 20px;color:white">Laboratory Service</a>
		
	
	<a href="help.jsp" style="text-decoration:none;padding:10px 20px;color:white">Help & Support</a>
	...
	<h2 style="width: 100%;background-color: #B497D4;color: white;"><CENTER>Help & Support</CENTER></h2>
